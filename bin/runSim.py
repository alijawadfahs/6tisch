...
def parseCliOptions():
    ...
    parser.add_argument( '--queuing',
        dest       = 'queuing',
        nargs      = '+',
        type       = int,
        default    = 0,
        help       = 'Queuing type (0 : default queuing, 1 : priority queuing).',
    )

    parser.add_argument( '--topology',
        dest = 'topology',
        action = 'store_true',
        help = 'use topology read / write',
    )
    ...
    parser.add_argument('--rw',
        ...
        type = str,
        default = None,
        help = 'read or write topology file',
    )

    parser.add_argument('--bootstrap',
        dest = 'bootstrap',
        action = 'store_true',
        help = 'handle or not network bootstrap',
    )

    parser.add_argument('--numSharedSlots',
        dest = 'numSharedSlots',
        nargs = '+',
        type = int,
        default = 1,
        help = 'number of shared slots in one slot frame',
    )

    parser.add_argument('--opportunist',
        dest = 'opportunist',
        nargs = '+',
        type = bool,
        default = False,
        help = 'sends control paquets through dedicated slot when there is',
    )

    parser.add_argument('--idealAllocation',
        dest = 'idealAllocation',
        nargs = '+',
        type = bool,
        default = False,
        help = 'god mode',
